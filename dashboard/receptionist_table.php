      ...
      <div class="w-full overflow-x-auto">
        <table class="w-full whitespace-no-wrap">
          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            <?php foreach ($receptionist_table as $receptionists_list) : ?>
              <tr class="text-gray-700 dark:text-gray-400">
                <td class="px-4 py-3">
                  <div class="flex items-center text-sm">
                    <div>
                      <p class="font-semibold"><?= $receptionists_list["name"]; ?></p>
                    </div>
                  </div>
                </td>
                <td class="px-4 py-3 text-sm">
                  <?= $receptionists_list["email"]; ?>
                </td>
                <td class="px-4 py-3 text-sm">
                  <?= $receptionists_list["user_type_name"]; ?>
                </td>
                <td class="px-4 py-3 text-sm">
                  <?= $receptionists_list["national_id"] ; ?>
                </td>
                <td class="px-4 py-3 text-sm">
                  <?= $receptionists_list["birth_date"]  ?>
                </td>
